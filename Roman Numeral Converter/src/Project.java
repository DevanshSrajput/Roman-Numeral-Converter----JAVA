...
class Project {
    public static void main(String[] args) {
        ...
        rti a = new rti();
        itr b = new itr();
        System.out.print("Welcome!\nThis is a program that can be used to convert roman numerals to integer and versa.");
        ...
        while (true) {
            if (i == 1) {
                ...
                String ans = b.action();
                if (ans=="error") 
                System.out.println("Integer must be under 4000!");
                else
        ...
        System.out.println("Thank You, Your Support means a lot !");
    }
}
